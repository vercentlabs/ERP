...
import type { CatalogCreateInput, CatalogListRequest, CatalogRecord, CatalogUpdateInput } from "./types";
...
export const catalogRepository = {
  async list(request: CatalogListRequest): Promise<PageResult<CatalogRecord>> {
  ...
  async create(input: CatalogCreateInput, actorId = "system"): Promise<CatalogRecord> {
    const timestamp = now();
  ...
  async update(tenantId: string, id: string, input: CatalogUpdateInput, actorId = "system") {
