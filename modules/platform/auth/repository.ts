...
import type { AuthCreateInput, AuthListRequest, AuthRecord, AuthUpdateInput } from "./types";
...
export const authRepository = {
  async list(request: AuthListRequest): Promise<PageResult<AuthRecord>> {
  ...
  async create(input: AuthCreateInput, actorId = "system"): Promise<AuthRecord> {
    const timestamp = now();
  ...
  async update(tenantId: string, id: string, input: AuthUpdateInput, actorId = "system") {
