...
import type { LearningCreateInput, LearningListRequest, LearningRecord, LearningUpdateInput } from "./types";
...
export const learningRepository = {
  async list(request: LearningListRequest): Promise<PageResult<LearningRecord>> {
  ...
  async create(input: LearningCreateInput, actorId = "system"): Promise<LearningRecord> {
    const timestamp = now();
  ...
  async update(tenantId: string, id: string, input: LearningUpdateInput, actorId = "system") {
