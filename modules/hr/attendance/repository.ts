...
import type { AttendanceCreateInput, AttendanceListRequest, AttendanceRecord, AttendanceUpdateInput } from "./types";
...
export const attendanceRepository = {
  async list(request: AttendanceListRequest): Promise<PageResult<AttendanceRecord>> {
  ...
  async create(input: AttendanceCreateInput, actorId = "system"): Promise<AttendanceRecord> {
    const timestamp = now();
  ...
  async update(tenantId: string, id: string, input: AttendanceUpdateInput, actorId = "system") {
