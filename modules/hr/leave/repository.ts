...
import type { LeaveCreateInput, LeaveListRequest, LeaveRecord, LeaveUpdateInput } from "./types";
...
export const leaveRepository = {
  async list(request: LeaveListRequest): Promise<PageResult<LeaveRecord>> {
  ...
  async create(input: LeaveCreateInput, actorId = "system"): Promise<LeaveRecord> {
    const timestamp = now();
  ...
  async update(tenantId: string, id: string, input: LeaveUpdateInput, actorId = "system") {
