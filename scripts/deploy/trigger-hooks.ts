export type TriggerHooksInput = {
  tenantId?: string;
  environment?: "local" | "dev" | "staging" | "production";
  dryRun?: boolean;
};

export type TriggerHooksResult = {
  script: "trigger-hooks";
  category: "deploy";
...
export async function run(input: TriggerHooksInput = {}): Promise<TriggerHooksResult> {
