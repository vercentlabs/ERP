export type MigrateCurrentCrmInput = {
  tenantId?: string;
  environment?: "local" | "dev" | "staging" | "production";
  dryRun?: boolean;
};

export type MigrateCurrentCrmResult = {
  script: "migrate-current-crm";
...
export async function run(input: MigrateCurrentCrmInput = {}): Promise<MigrateCurrentCrmResult> {
