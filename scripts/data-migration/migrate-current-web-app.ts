export type MigrateCurrentWebAppInput = {
  tenantId?: string;
  environment?: "local" | "dev" | "staging" | "production";
  dryRun?: boolean;
};

export type MigrateCurrentWebAppResult = {
  script: "migrate-current-web-app";
...
export async function run(input: MigrateCurrentWebAppInput = {}): Promise<MigrateCurrentWebAppResult> {
