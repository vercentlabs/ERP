export type MigrateCurrentServicesInput = {
  tenantId?: string;
  environment?: "local" | "dev" | "staging" | "production";
  dryRun?: boolean;
};

export type MigrateCurrentServicesResult = {
  script: "migrate-current-services";
...
export async function run(input: MigrateCurrentServicesInput = {}): Promise<MigrateCurrentServicesResult> {
