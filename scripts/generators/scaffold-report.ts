export type ScaffoldReportInput = {
  tenantId?: string;
  environment?: "local" | "dev" | "staging" | "production";
  dryRun?: boolean;
};

export type ScaffoldReportResult = {
  script: "scaffold-report";
  category: "generators";
...
export async function run(input: ScaffoldReportInput = {}): Promise<ScaffoldReportResult> {
