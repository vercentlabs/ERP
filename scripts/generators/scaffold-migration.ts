export type ScaffoldMigrationInput = {
  tenantId?: string;
  environment?: "local" | "dev" | "staging" | "production";
  dryRun?: boolean;
};

export type ScaffoldMigrationResult = {
  script: "scaffold-migration";
  category: "generators";
...
export async function run(input: ScaffoldMigrationInput = {}): Promise<ScaffoldMigrationResult> {
