export type BackupAndVerifyInput = {
  tenantId?: string;
  environment?: "local" | "dev" | "staging" | "production";
  dryRun?: boolean;
};

export type BackupAndVerifyResult = {
  script: "backup-and-verify";
  category: "backups";
...
export async function run(input: BackupAndVerifyInput = {}): Promise<BackupAndVerifyResult> {
