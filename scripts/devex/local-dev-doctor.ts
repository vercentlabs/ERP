export type LocalDevDoctorInput = {
  tenantId?: string;
  environment?: "local" | "dev" | "staging" | "production";
  dryRun?: boolean;
};

export type LocalDevDoctorResult = {
  script: "local-dev-doctor";
  category: "devex";
...
export async function run(input: LocalDevDoctorInput = {}): Promise<LocalDevDoctorResult> {
